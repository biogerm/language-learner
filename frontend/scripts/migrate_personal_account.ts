...
async function migratePersonalUser() {
  ...
  // 2. Clear existing records for this user (if any)
  console.log('🧹 Cleaning previous records for official personal user...');
