...
replacements = {
    ...
    1: [("långt före vi bygger dem", "långt innan vi bygger dem")], # Ignored sätta på datorn
    ...
    8: [("univerisitet", "universitet"), ("blåsa torr sitt hår", "blåsa håret torrt")],
    ...
    11: [("giantisk", "gigantisk")], # Ignored summa språk -> mängd språk
    12: [("ntally", "mentalt")],
    ...
    21: [("En spanske turist", "En spansk turist"), ("himla vackert", "en suggestiv miljö"), ("Han tyckte om både...och när det gällde växter och djur.", "Han tyckte om både växter och djur.")],
    ...
    27: [("alkis /alkoholist", "alkoholist"), ("alkis/alkoholist", "alkoholist"), ("fylle- misstag", "fyllemisstag"), ("viktigt genom att det hjälper", "viktigt eftersom det hjälper"), ("kan leva kvar de senaste", "har kunnat leva kvar i")],
    ...
    32: [("skynda på rejält", "skynda mig rejält"), ("flytta ut på stan", "ge mig ut på stan"), ("av en storlek som var enorm", "som var enorma"), ("torka sig själv", "torka sig"), ("som nog kanske var dräktig", "som kanske var dräktig")],
    ...
    38: [("i vår telefon", "över telefon"), ("en aktiv fritidsvana", "en aktiv fritid"), ("förvånansvärd stor", "förvånansvärt stor"), ("sätter på mig min skridsko", "sätter på mig mina skridskor"), ("tysta golfspelare", "tysta golfspelarna"), ("täckta av jordig mark", "täckta av jord")],
...
def apply():
    ...
    # Hardcode fixes for tricky target words
    for step in data.get("steps", []):
        for article in step.get("articles", []):
            for sentence in article.get("sentences", []):
                sv_text = sentence["sv"]
    ...
    # Also update the individual files in articles/
    for step in data.get("steps", []):
        for article in step.get("articles", []):
